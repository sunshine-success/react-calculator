...
const Pad: FunctionComponent<PadProps> = ({
  ...
  const handleKeyDown = ({ keyCode, shiftKey }: KeyboardEvent) => {
    if (keyCode >= 48 && keyCode <= 57 && !shiftKey) {
      ...
      onOperatorButtonClick('÷')
    } else if (keyCode === 13 || (keyCode === 187 && !shiftKey)) { //Press Enter
      onEqualButtonClick()
    } else if (keyCode === 46) { //Press Delete
      onClearEntryButtonClick()
    } else if (keyCode === 27) { //Press Esc
      onAllClearButtonClick()
    } else if (keyCode === 78) { //Press n
      onChangeSignButtonClick()
    } else if (keyCode === 80) { //Press p
      onMemoryPlusButtonClick()
    } else if (keyCode === 77) { //Press m
      onMemoryMinusButtonClick()
    } else if (keyCode === 82) { //Press r
      onMemoryRecallButtonClick()
    } else if (keyCode === 67) { //Press c
      onMemoryClearButtonClick()
